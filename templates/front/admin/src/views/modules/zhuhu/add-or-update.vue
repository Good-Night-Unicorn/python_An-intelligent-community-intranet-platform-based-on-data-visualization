<template>
	<div class="addEdit-block" :style='{"padding":"0px"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="住户账号" prop="zhuhuzhanghao">
					<el-input v-model="ruleForm.zhuhuzhanghao" placeholder="住户账号" clearable  :readonly="ro.zhuhuzhanghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="住户账号" prop="zhuhuzhanghao">
					<el-input v-model="ruleForm.zhuhuzhanghao" placeholder="住户账号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="密码" prop="mima">
					<el-input v-model="ruleForm.mima" placeholder="密码" clearable  :readonly="ro.mima"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="密码" prop="mima">
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="性别" prop="xingbie">
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="性别" prop="xingbie">
					<el-input v-model="ruleForm.xingbie"
						placeholder="性别" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="年龄" prop="nianling">
					<el-input v-model="ruleForm.nianling" placeholder="年龄" clearable  :readonly="ro.nianling"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="年龄" prop="nianling">
					<el-input v-model="ruleForm.nianling" placeholder="年龄" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="手机" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="手机" clearable  :readonly="ro.shouji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="手机" prop="shouji">
					<el-input v-model="ruleForm.shouji" placeholder="手机" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="楼栋号" prop="loudonghao">
					<el-select :disabled="ro.loudonghao" v-model="ruleForm.loudonghao" placeholder="请选择楼栋号" >
						<el-option
							v-for="(item,index) in loudonghaoOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="楼栋号" prop="loudonghao">
					<el-input v-model="ruleForm.loudonghao"
						placeholder="楼栋号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="身份证号" prop="shenfenzhenghao">
					<el-input v-model="ruleForm.shenfenzhenghao" placeholder="身份证号" clearable  :readonly="ro.shenfenzhenghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="身份证号" prop="shenfenzhenghao">
					<el-input v-model="ruleForm.shenfenzhenghao" placeholder="身份证号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="犯罪前科" prop="fanzuiqianke">
					<el-select :disabled="ro.fanzuiqianke" v-model="ruleForm.fanzuiqianke" placeholder="请选择犯罪前科" >
						<el-option
							v-for="(item,index) in fanzuiqiankeOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else class="input" label="犯罪前科" prop="fanzuiqianke">
					<el-input v-model="ruleForm.fanzuiqianke"
						placeholder="犯罪前科" readonly></el-input>
				</el-form-item>
			</template>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				fanzuiqianke: [
					{ required: true, message: '犯罪前科不能为空', trigger: 'blur' },
				],
			}
		};
	},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='fanzuiqianke'){
							this.ruleForm.fanzuiqianke = obj[o];
							this.ro.fanzuiqianke = true;
							continue;
						}
				}
            ...
            this.loudonghaoOptions = "A栋,B栋,C栋,D栋,E栋,F栋,G栋,H栋,I栋,J栋,K栋,L栋".split(',')
            this.fanzuiqiankeOptions = "有,无".split(',')
