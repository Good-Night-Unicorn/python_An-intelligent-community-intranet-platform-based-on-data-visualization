	...
	<div class="addEdit-block" :style='{"padding":"0px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.picture" label="图片" prop="picture">
					<file-upload
						tip="点击上传图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.picture" label="图片" prop="picture">
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="简介" prop="introduction">
					<el-input
				...
				<el-form-item :style='{"width":"49%","float":"left","margin":"0 0 20px 0"}' v-else-if="ruleForm.introduction" label="简介" prop="introduction">
					<span :style='{"fontSize":"14px","lineHeight":"24px","color":"#888","fontWeight":"500","display":"inline-block"}'>{{ruleForm.introduction}}</span>
				</el-form-item>
